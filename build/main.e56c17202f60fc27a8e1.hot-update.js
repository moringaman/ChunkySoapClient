...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  send: function send(url, method, data) {
    ...
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var type, apiAddress, token, baseURL, myHeaders, raw, requestOptions, maxAttempts;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              maxAttempts = 3;
              return _context.abrupt("return", fetch("".concat(baseURL).concat(url), requestOptions, retries = 3).then(function (response) {
...
//# sourceMappingURL=main.e56c17202f60fc27a8e1.hot-update.js.map